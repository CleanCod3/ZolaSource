...
void CGInterface::AfterOnCreate() {
    ...
    if (CPSMission::Icon_AutoEquipMent)
    {
        CreateFlorian0Event8(); //AutoEquipment
    }
...
void CGInterface::CreateFlorian0Event8() {
    CGWnd* guide = GetAlarmManager()->GetGuide(GUIDE_FLORIAN09);
}
