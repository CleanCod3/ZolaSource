...
//        m_textbox->BringToFront();
    ...
    if (msg->msgid() == 0xB888) //notice
    {
        ...
        bool XsmbEnable;
        bool LotoEnable;
        *msg >> notice>>GUIIconTaiXiu>>GUIIconDailyLogin>>GUIIconExTraFeatures>>GUIIconRebot>>DoubleClickLogin>>GUIIconChest>>GUIIconEvent>>GUIIconLive >>XsmbEnable>>LotoEnable>>GUIIconEquip;
        ...
        CPSMission::Icon_AutoEquipMent = GUIIconEquip;
