...
void __stdcall WriteToChatWindow(ChatType type, const std::n_wstring &strRecipient, int uniqueid,
   ...
   /* size_t start_pos2 = 0;
    ...
    if (type == CHAT_Global) {
        ...
        {
            if (strMessageCopy.find(L"1`") == 0) {//red 1
                strMessageCopy.erase(0, 2);
                color =  D3DCOLOR_RGBA(255, 0, 0, 255);
            }
            else  if (strMessageCopy.find(L"2`") == 0) {//Blue 1
                strMessageCopy.erase(0, 2);
                color = D3DCOLOR_RGBA(0, 0, 255, 255);
            }
            else  if (strMessageCopy.find(L"3`") == 0) {//Green 1
                strMessageCopy.erase(0, 2);
                color = D3DCOLOR_RGBA(0, 255, 0, 255);
            }
            else   if (strMessageCopy.find(L"4`") == 0) {//sKY
                strMessageCopy.erase(0, 2);
                color = D3DCOLOR_RGBA(0, 248, 255, 255);
            }
            else if (strMessageCopy.find(L"5`") == 0) {//Orange 1
                strMessageCopy.erase(0, 2);
                color = 0xFF4500;
            }
            else  if (strMessageCopy.find(L"6`") == 0) {//DarkGreen	1
                strMessageCopy.erase(0, 2);
                color = 0x008040;
            }
            else   if (strMessageCopy.find(L"7`") == 0) {//Purble	1
                strMessageCopy.erase(0, 2);
                color = 0x8b1a89;
			}
			else  if (strMessageCopy.find(L"8`") == 0) {//Gray 1
                strMessageCopy.erase(0, 2);
                color =0xB8B8B8;
            }
			else  if (strMessageCopy.find(L"9`") == 0) {//Black 1
                strMessageCopy.erase(0, 2);
                color =0x000000;
            }
			else  if (strMessageCopy.find(L"10`") == 0) {//Olive  1
                strMessageCopy.erase(0, 2);
                color =0x808000;
            }
			else  if (strMessageCopy.find(L"11`") == 0) {//DarkSlateGray  1
                strMessageCopy.erase(0, 2);
                color =0x2F4F4F;
            }
			else  if (strMessageCopy.find(L"12`") == 0) {//Fuchsia  1
                strMessageCopy.erase(0, 2);
                color =0xFF00FF;
            }
			else  if (strMessageCopy.find(L"13`") == 0) {//DarkKhaki  1
                strMessageCopy.erase(0, 2);
                color =0xBDB76B;
            }
			else  if (strMessageCopy.find(L"14`") == 0) {//GreenYellow  1
                strMessageCopy.erase(0, 2);
                color =0xADFF2F;
            }
			else  if (strMessageCopy.find(L"15`") == 0) {//mIX 1
                strMessageCopy.erase(0, 2);
                color =0x705200;
            }
            else
